...
export default (props) => {
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                <Card.Text>
                    <dd className='myName'><Name width='18px' height='18px' /> {author.name.jp}</dd>
                    <dd className='myAge'><Age width='18px' height='18px' /> <AboutProfileAge />歳</dd>
                    <dd className='myLocation'><Location width='18px' height='18px' /> {author.location.jp}</dd>
                    <dd className='myEmail'><a href='mailto:terada.syun.kim@gmail.com' className='myMail'><Email width='18px' height='18px' /> {author.email.jp}</a></dd>
                    <dd className='myWord'> <Word width='18px' height='18px' /> {author.word.jp}</dd>
                </Card.Text>
            </Card.Body>
        </Card>
    )
